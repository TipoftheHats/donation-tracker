# -*- coding: utf-8 -*-
# Generated by Django 1.11.23 on 2020-02-03 08:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(default=tracker.models.util.LatestEvent, on_delete=django.db.models.deletion.PROTECT, to='tracker.Event')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='prize',
            name='event',
            field=models.ForeignKey(default=tracker.models.util.LatestEvent, on_delete=django.db.models.deletion.PROTECT, to='tracker.Event'),
        ),
        migrations.AddField(
            model_name='prize',
            name='startrun',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estimate', tracker.models.fields.TimestampField()),
            ],
        ),
        ...
        migrations.AddField(
            model_name='speedrun',
            name='run_time',
            field=tracker.models.fields.TimestampField(default=0),
        ...
        migrations.AddField(
            model_name='donation',
            name='steamid',
            field=models.CharField(blank=True, max_length=64, verbose_name=b'SteamID 64'),
        ),
        migrations.AddField(
            model_name='donation',
