...
class DonationAdmin(CustomModelAdmin):
    ...
    list_display = ('id', 'visible_donor_name', 'amount', 'comment', 'commentlanguage', 'timereceived',
                    'event', 'domain', 'transactionstate', 'bidstate', 'readstate', 'commentstate', 'steamid')
    list_editable = ('transactionstate', 'bidstate',
                     'readstate', 'commentstate', 'steamid')
    search_fields_base = ('donor__alias', 'amount',
                          'comment', 'modcomment', 'steamid')
    ...
    fieldsets = [
        ...
        ('Extra Donor Info', {'fields': (
            ('requestedvisibility', 'requestedalias', 'requestedemail', 'requestedsolicitemail', 'steamid'),)}),
